...
OPCODES: list[Opcode] = [
    ...
    Opcode(147, "Stream",       -1, "passive", ("500", "C2"),
           "N then N packet IDs. Streams at 15 Hz framed by header 19. UNKNOWN on 770."),
    Opcode(148, "Query List",   -1, "passive", ("500", "C2", "700?"),
           "N then N packet IDs; replies once with concatenated packets."),
    Opcode(149, "Pause/Resume Stream", 1, "passive", ("500", "C2"),
           "0=pause, 1=resume. UNKNOWN on 770."),
...
SENSOR_PACKETS: list[SensorPacket] = [
    ...
    SensorPacket(38, "Number of Stream Packets",   1, False, ("500", "C2")),
